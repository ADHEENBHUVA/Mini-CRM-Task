    ...
    return (
        <div className="flex flex-col gap-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                {/* Profile Card */}
                <div className="lg:col-span-1 border border-slate-200 dark:border-[#1E293B] bg-white dark:bg-[#0F172A] rounded-3xl p-6 sm:p-8 flex flex-col items-center shadow-lg dark:shadow-xl transition-colors sticky top-8 h-fit">
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 p-1 shadow-lg shadow-indigo-500/30 mb-4 overflow-hidden flex items-center justify-center">
                        {employee.avatar ? (
                            <img src={employee.avatar} alt="Profile" className="w-full h-full rounded-full object-cover bg-white dark:bg-[#0B0F19]" />
                        ) : (
