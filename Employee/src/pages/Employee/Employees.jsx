                                ...
                                filteredEmployees.map((emp) => (
                                    <tr key={emp._id} className="hover:bg-slate-50/80 dark:hover:bg-[#151D2C]/80 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 text-right space-x-2">
                                            <Link to={`/employees/${emp._id}`} className="p-2 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-all inline-block" title="View Details">
